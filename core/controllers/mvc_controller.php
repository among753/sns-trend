	...
	protected function load_helper($helper_name) {
		...
		if (class_exists($helper_name)) {
			...
			if ($helper_name == 'FormHelper') {
				//PHP5.4 Warning: Creating default object from empty value in /Users/KS/Sites/test.localhost/htdocs/wp-content/plugins/wp-mvc/core/controllers/mvc_controller.php on line 110
